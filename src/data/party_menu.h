...
{
    [MENU_SUMMARY]         = {COMPOUND_STRING("RESUMÉ"),         CursorCb_Summary},
    [MENU_SWITCH]          = {COMPOUND_STRING("ÉCHANGER"),          CursorCb_Switch},
    [MENU_CANCEL1]         = {gText_Cancel2,                      CursorCb_Cancel1},
    [MENU_ITEM]            = {COMPOUND_STRING("OBJET"),            CursorCb_Item},
    [MENU_GIVE]            = {gMenuText_Give,                     CursorCb_Give},
    [MENU_TAKE_ITEM]       = {COMPOUND_STRING("PRENDRE"),            CursorCb_TakeItem},
    [MENU_MOVE_ITEM]       = {COMPOUND_STRING("DÉPLACER"),            CursorCb_MoveItem},
    ...
    [MENU_SHIFT]           = {COMPOUND_STRING("ÉCHANGER"),           CursorCb_SendMon},
    [MENU_SEND_OUT]        = {COMPOUND_STRING("ENVOYER"),        CursorCb_SendMon},
    [MENU_ENTER]           = {COMPOUND_STRING("ENTRER"),           CursorCb_Enter},
    [MENU_NO_ENTRY]        = {COMPOUND_STRING("PAS D'ENTRÉE"),        CursorCb_NoEntry},
    [MENU_STORE]           = {COMPOUND_STRING("STOCKER"),           CursorCb_Store},
    ...
    [MENU_CATALOG_FRIDGE]  = {COMPOUND_STRING("éfrigérateur"),    CursorCb_CatalogFridge},
    ...
    [MENU_CHANGE_FORM]     = {COMPOUND_STRING("Changer de forme"),     CursorCb_ChangeForm},
    [MENU_CHANGE_ABILITY]  = {COMPOUND_STRING("Changer l'abilité"),  CursorCb_ChangeAbility},
};
