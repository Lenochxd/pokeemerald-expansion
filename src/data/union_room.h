...
ALIGNED(4) static const u8 sText_RecordCorner[] = _("COIN DES RECORDS");
ALIGNED(4) static const u8 sText_CoolContest[] = _("CONCOURS COOL");
ALIGNED(4) static const u8 sText_BeautyContest[] = _("CONCOURS BEAUTÉ");
ALIGNED(4) static const u8 sText_CuteContest[] = _("CONCOURS MIGNON");
ALIGNED(4) static const u8 sText_SmartContest[] = _("CONCOURS INTELLIGENT");
ALIGNED(4) static const u8 sText_ToughContest[] = _("CONCOURS DUR");
ALIGNED(4) static const u8 sText_BattleTowerLv50[] = _("TOUR DE COMBAT LV. 50");
ALIGNED(4) static const u8 sText_BattleTowerOpenLv[] = _("TOUR DE COMBAT NIVEAU OUVERT");
