...
const u16 gMetatiles_PortDocil[] = INCBIN_U16("data/tilesets/secondary/portdocil/metatiles.bin");
const u16 gMetatileAttributes_PortDocil[] = INCBIN_U16("data/tilesets/secondary/portdocil/metatile_attributes.bin");
