...
const struct Tileset gTileset_Gibounet =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_Gibounet,
    .palettes = gTilesetPalettes_Gibounet,
    .metatiles = gMetatiles_Gibounet,
    .metatileAttributes = gMetatileAttributes_Gibounet,
    .callback = NULL,
};
