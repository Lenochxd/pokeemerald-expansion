...
const struct Tileset gTileset_HaieFroide =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_HaieFroide,
    .palettes = gTilesetPalettes_HaieFroide,
    .metatiles = gMetatiles_HaieFroide,
    .metatileAttributes = gMetatileAttributes_HaieFroide,
    .callback = NULL,
};
