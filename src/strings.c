...
const u8 gText_ExpandedPlaceholder_Antoine[] = _("ANTOINE");
...
const u8 gText_ThatItemIsSoldOut[] = _("Désolé, mais ceci n'est plus en stock.{PAUSE_UNTIL_PRESS}");
const u8 gText_SoldOut[] = _("HORS STOCK");
...
const u8 gText_NextFusionMon[] = _("Choisissez {PKMN} pour fusionner.");
...
const u8 gText_PkmnTransformed[] = _("{STR_VAR_1} s'est transformé !{PAUSE_UNTIL_PRESS}");
const u8 gText_ThrowAwayItem[] = _("Jeter {STR_VAR_1} ?");
const u8 gText_ItemThrownAway[] = _("{STR_VAR_1} a été jeté.{PAUSE_UNTIL_PRESS}");
const u8 gText_TeachWhichPokemon2[] = _("Enseigner à quel POKéMON ?"); // Unused
...
const u8 gText_SendWhichMonToPC[] = _("Envoyer quel PKMN au PC ?");
const u8 gText_MoveItemWhere[] = _("Où déplacer l'objet ?");
...
const u8 gText_WhichAppliance[] = _("Ordre de quel\nappareil ?");
