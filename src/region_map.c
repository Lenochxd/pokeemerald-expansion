...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_BOURG_EN_BIOL] = {MAP_GROUP(MAP_BOURG_EN_BIOL), MAP_NUM(MAP_BOURG_EN_BIOL), HEAL_LOCATION_BOURG_EN_BIOL},
...
static u8 GetMapsecType(mapsec_u16_t mapSecId)
{
    ...
    case MAPSEC_BOURG_EN_BIOL:
        return FlagGet(FLAG_VISITED_BOURG_EN_BIOL) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
...
static const struct FlyLocation sFlyLocations[] =
{
    ...
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_BOURG_EN_BIOL,
        .flag = FLAG_VISITED_BOURG_EN_BIOL,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
