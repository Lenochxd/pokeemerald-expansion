...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_TRYTOLEARNMOVE1] = COMPOUND_STRING("{B_BUFF1} tente d'apprendre\n{B_BUFF2}.\p"),
    [STRINGID_TRYTOLEARNMOVE2] = COMPOUND_STRING("Mais {B_BUFF1} ne peut pas\navoir plus de quatre capacités.\p"),
    [STRINGID_TRYTOLEARNMOVE3] = COMPOUND_STRING("Effacer une ancienne\ncapacité pour {B_BUFF2}?"),
    ...
    [STRINGID_PKMNLEARNEDMOVE2] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} apprend\n{B_BUFF1}!"),
    ...
    [STRINGID_STATSWONTINCREASE2] = COMPOUND_STRING("Les stats du {B_ATK_NAME_WITH_PREFIX}\nn'iront pas plus haut!"),
    [STRINGID_ITDOESNTAFFECT] = COMPOUND_STRING("Ça n'affecte pas\n{B_DEF_NAME_WITH_PREFIX}…"),
    ...
    [STRINGID_PLAYERGOTMONEY] = COMPOUND_STRING("{B_PLAYER_NAME} remporte {B_BUFF1}¥!\p"),
    [STRINGID_PLAYERWHITEOUT] = COMPOUND_STRING("{B_PLAYER_NAME} n'a plus de\nPOKéMON en forme!\p"),
    ...
    [STRINGID_HITXTIMES] = COMPOUND_STRING("Touché {B_BUFF1} fois!"), //SV has dynamic plural here
    ...
    [STRINGID_PKMNALREADYPOISONED] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} est déjà\nempoisonné."),
    [STRINGID_PKMNBADLYPOISONED] = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} est gravement\nempoisonné!"),
    [STRINGID_PKMNENERGYDRAINED] = COMPOUND_STRING("L'énergie du {B_DEF_NAME_WITH_PREFIX}\nest drainée!"),
    ...
    [STRINGID_PKMNHURTBYBURN] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} souffre de\nsa brûlure!"),
    ...
    [STRINGID_PKMNISFROZEN] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} est gelé!"),
    [STRINGID_PKMNWASDEFROSTED] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} est dégelé!"),
    [STRINGID_PKMNWASDEFROSTEDBY] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} est dégelé\npar {B_CURRENT_MOVE}!"),
    [STRINGID_PKMNWASPARALYZED] = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} est paralysé!\nIl peut ne plus attaquer!"),
    ...
    [STRINGID_PKMNISPARALYZED] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} est paralysé!\nIl ne peut plus attaquer!"),
    [STRINGID_PKMNISALREADYPARALYZED] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} est déjà\nparalysé!"),
    [STRINGID_PKMNHEALEDPARALYSIS] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} n'est plus\nparalysé!"),
    [STRINGID_STATSWONTINCREASE] = COMPOUND_STRING("Ah, {B_BUFF1} de {B_ATK_NAME_WITH_PREFIX}\nn'ira pas plus haut!"),
    [STRINGID_STATSWONTDECREASE] = COMPOUND_STRING("Ah, {B_BUFF1} de {B_DEF_NAME_WITH_PREFIX}\nn'ira pas plus bas!"),
    [STRINGID_PKMNISCONFUSED] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} est confus!"),
    [STRINGID_PKMNHEALEDCONFUSION] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} n'est plus\nconfus!"),
    [STRINGID_PKMNWASCONFUSED] = COMPOUND_STRING("Cela rend {B_EFF_NAME_WITH_PREFIX}\nconfus!"),
    [STRINGID_PKMNALREADYCONFUSED] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} est\ndéjà confus!"),
    ...
    [STRINGID_PKMNIMMOBILIZEDBYLOVE] = COMPOUND_STRING("L'amour empêche {B_ATK_NAME_WITH_PREFIX}\nd'attaquer!"),
    [STRINGID_PKMNCHANGEDTYPE] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} prend le\ntype {B_BUFF1}!"),
    [STRINGID_PKMNFLINCHED] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} a la trouille!"),
    [STRINGID_PKMNREGAINEDHEALTH] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} récupère\nson énergie!"),
    [STRINGID_PKMNHPFULL] = COMPOUND_STRING("Les PV du {B_DEF_NAME_WITH_PREFIX} sont\nau maximum!"),
    [STRINGID_PKMNRAISEDSPDEF] = COMPOUND_STRING("{B_CURRENT_MOVE} du POKéMON  \naugmente sa DEF. SPE.!"),
    [STRINGID_PKMNRAISEDDEF] = COMPOUND_STRING("{B_CURRENT_MOVE} du POKéMON \naugmente sa DEFENSE!"),
    [STRINGID_PKMNCOVEREDBYVEIL]                    = COMPOUND_STRING("{B_ATK_TEAM1} team cloaked itself in a mystical veil!"),
    [STRINGID_PKMNUSEDSAFEGUARD] = COMPOUND_STRING("L'équipe de {B_DEF_NAME_WITH_PREFIX} est\nprotégée par RUNE PROTECT!"),
    [STRINGID_PKMNSAFEGUARDEXPIRED]                 = COMPOUND_STRING("{B_ATK_TEAM1} team is no longer protected by Safeguard!"),
    [STRINGID_PKMNWENTTOSLEEP] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} s'endort!"), //not in gen 5+
    [STRINGID_PKMNSLEPTHEALTHY] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} dort et\nrécupère son énergie!"),
    [STRINGID_PKMNWHIPPEDWHIRLWIND] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} déclenche un\ncyclone!"),
    [STRINGID_PKMNTOOKSUNLIGHT] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} rayonne!"),
    [STRINGID_PKMNLOWEREDHEAD] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} baisse la tête!"),
    [STRINGID_PKMNISGLOWING] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} est entouré d'une\nlumière intense!"),
    [STRINGID_PKMNFLEWHIGH] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} s'envole!"),
    [STRINGID_PKMNDUGHOLE] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} creuse un trou!"),
    [STRINGID_PKMNSQUEEZEDBYBIND] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} est pris dans\nl'ETREINTE du {B_ATK_NAME_WITH_PREFIX}!"),
    [STRINGID_PKMNTRAPPEDINVORTEX] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} est piégé dans\nle tourbillon!"),
    [STRINGID_PKMNWRAPPEDBY] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} est LIGOTE\npar {B_ATK_NAME_WITH_PREFIX}!"),
    [STRINGID_PKMNCLAMPED] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} est pris dans\nle CLAQUOIR du {B_ATK_NAME_WITH_PREFIX}!"),
    [STRINGID_PKMNHURTBY] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} est blessé par\n{B_BUFF1}!"),
    [STRINGID_PKMNFREEDFROM] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} est libéré de\n{B_BUFF1}!"),
    [STRINGID_PKMNCRASHED] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} s'écrase au\nsol!"),
    ...
    [STRINGID_PKMNHITWITHRECOIL] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} se blesse en\nfrappant!"),
    [STRINGID_PKMNPROTECTEDITSELF2] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} est prêt à\nse protéger!"),
    [STRINGID_PKMNBUFFETEDBYSANDSTORM] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} est secoué\npar la tempête de sable!"),
    [STRINGID_PKMNPELTEDBYHAIL] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} est frappé par\nla GRELE!"),
    ...
    [STRINGID_PKMNSAPPEDBYLEECHSEED] = COMPOUND_STRING("VAMPIGRAINE draine\nl'énergie de {B_ATK_NAME_WITH_PREFIX}!"),
    [STRINGID_PKMNFASTASLEEP] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} dort\nprofondément."),
    [STRINGID_PKMNWOKEUP] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} se réveille!"),
    [STRINGID_PKMNWOKEUPINUPROAR] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} est réveillé par\nle BROUHAHA!"),
    [STRINGID_PKMNCAUSEDUPROAR] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} provoque\nun BROUHAHA!"),
    [STRINGID_PKMNMAKINGUPROAR] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} fait un\nBROUHAHA!"),
    [STRINGID_PKMNCALMEDDOWN] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} se calme."),
    [STRINGID_PKMNSTOCKPILED] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} utilise STOCKAGE\n{B_BUFF1} fois!"),
    [STRINGID_PKMNCANTSLEEPINUPROAR2] = COMPOUND_STRING("Mais le BROUHAHA empêche\n{B_DEF_NAME_WITH_PREFIX} de dormir!"),
    [STRINGID_UPROARKEPTPKMNAWAKE] = COMPOUND_STRING("Mais le BROUHAHA tient\n{B_DEF_NAME_WITH_PREFIX} éveillé!"),
    [STRINGID_PKMNSTAYEDAWAKEUSING] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} reste éveillé\ngrâce à {B_DEF_ABILITY}!"), //not in gen 5+, ability popup
    [STRINGID_PKMNSTORINGENERGY] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} se concentre!"),
    [STRINGID_PKMNUNLEASHEDENERGY] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} envoie la sauce!"),
    [STRINGID_PKMNFATIGUECONFUSION] = COMPOUND_STRING("La fatigue rend {B_ATK_NAME_WITH_PREFIX}\nconfus!"),
    [STRINGID_PLAYERPICKEDUPMONEY] = COMPOUND_STRING("{B_PLAYER_NAME} obtient {B_BUFF1}¥!\p"),
    [STRINGID_PKMNUNAFFECTED] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} n'est pas\naffecté!"),
    [STRINGID_PKMNTRANSFORMEDINTO] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} se transforme\nen {B_BUFF1}!"),
    ...
    [STRINGID_SUBSTITUTEDAMAGED] = COMPOUND_STRING("Le CLONE prend les\ndégâts du {B_DEF_NAME_WITH_PREFIX}!\p"),
    [STRINGID_PKMNSUBSTITUTEFADED] = COMPOUND_STRING("Le CLONE du {B_DEF_NAME_WITH_PREFIX}\ndisparaît!\p"),
    [STRINGID_PKMNMUSTRECHARGE] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} doit\nse recharger!"),
    [STRINGID_PKMNRAGEBUILDING] = COMPOUND_STRING("La FRENESIE du {B_DEF_NAME_WITH_PREFIX}\naugmente!"),
    [STRINGID_PKMNMOVEWASDISABLED] = COMPOUND_STRING("{B_BUFF1} du {B_DEF_NAME_WITH_PREFIX}\nest mis sous ENTRAVE!"),
    [STRINGID_PKMNMOVEISDISABLED]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s {B_CURRENT_MOVE} is disabled!\p"),
    [STRINGID_PKMNMOVEDISABLEDNOMORE] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} n'est plus\nsous ENTRAVE!"),
    [STRINGID_PKMNGOTENCORE] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}, ENCORE\nune fois!"),
    [STRINGID_PKMNGOTENCOREDMOVE]                   = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} can only use {B_CURRENT_MOVE}!\p"),
    [STRINGID_PKMNENCOREENDED] = COMPOUND_STRING("ENCORE du {B_ATK_NAME_WITH_PREFIX}\nest terminé!"),
    [STRINGID_PKMNTOOKAIM] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} vise\n{B_DEF_NAME_WITH_PREFIX}!"),
    [STRINGID_PKMNSKETCHEDMOVE] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} GRIBOUILLE\n{B_BUFF1}!"),
    [STRINGID_PKMNTRYINGTOTAKEFOE] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} veut emmener son\nennemi au tapis!"),
    [STRINGID_PKMNTOOKFOE] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} emmène\n{B_ATK_NAME_WITH_PREFIX} au tapis!"),
    [STRINGID_PKMNREDUCEDPP] = COMPOUND_STRING("{B_BUFF1} du {B_DEF_NAME_WITH_PREFIX}\nbaisse de {B_BUFF2}!"),
    [STRINGID_PKMNSTOLEITEM] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} vole\n{B_LAST_ITEM} au\l{B_DEF_NAME_WITH_PREFIX}!"),
    [STRINGID_TARGETCANTESCAPENOW] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} ne peut pas\ns'échapper!"),
    [STRINGID_PKMNFELLINTONIGHTMARE] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} commence un\nCAUCHEMAR!"),
    [STRINGID_PKMNLOCKEDINNIGHTMARE] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} est prisonnier\nd'un CAUCHEMAR!"),
    [STRINGID_PKMNLAIDCURSE] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} sacrifie ses PV\net lance une MALEDICTION\lau {B_DEF_NAME_WITH_PREFIX}!"),
    [STRINGID_PKMNAFFLICTEDBYCURSE] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} est touché par\nla MALEDICTION!"),
    [STRINGID_SPIKESSCATTERED] = COMPOUND_STRING("Des PICOTS s'éparpillent autour\nde l'équipe de l'ennemi!"),
    [STRINGID_PKMNHURTBYSPIKES]                     = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} was hurt by the spikes!"),
    [STRINGID_PKMNIDENTIFIED] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} identifie\n{B_DEF_NAME_WITH_PREFIX}!"),
    [STRINGID_PKMNPERISHCOUNTFELL] = COMPOUND_STRING("Le compte du REQUIEM du\n{B_ATK_NAME_WITH_PREFIX} descend à {B_BUFF1}!"),
    [STRINGID_PKMNBRACEDITSELF] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} rassemble ses \nforces!"),
    [STRINGID_PKMNENDUREDHIT] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} est TENACE\nface au coup!"),
    [STRINGID_MAGNITUDESTRENGTH] = COMPOUND_STRING("AMPLEUR {B_BUFF1}!"),
    [STRINGID_PKMNCUTHPMAXEDATTACK] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} sacrifie ses PV\net monte son ATTAQUE au max!"),
    [STRINGID_PKMNCOPIEDSTATCHANGES] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} copie les\nchangements\lde stats du {B_DEF_NAME_WITH_PREFIX}!"),
    [STRINGID_PKMNGOTFREE] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} se libère\nde {B_BUFF1}\ldu {B_DEF_NAME_WITH_PREFIX}!"), //not in gen 5+, generic rapid spin?
    [STRINGID_PKMNSHEDLEECHSEED] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} repousse\nVAMPIGRAINE!"), //not in gen 5+, generic rapid spin?
    [STRINGID_PKMNBLEWAWAYSPIKES] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} repousse les\nPICOTS!"), //not in gen 5+, generic rapid spin?
    [STRINGID_PKMNFLEDFROMBATTLE] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} s'enfuit!"),
    [STRINGID_PKMNFORESAWATTACK] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} prévoit une\nattaque!"),
    [STRINGID_PKMNTOOKATTACK] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} prend l'attaque\nde {B_BUFF1}!"),
    [STRINGID_PKMNATTACK] = COMPOUND_STRING("Attaque de {B_BUFF1}!"), //not in gen 5+
    [STRINGID_PKMNCENTERATTENTION] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} devient le centre\nd'attention!"),
    [STRINGID_PKMNCHARGINGPOWER] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} se met à\ncharger son énergie!"),
    [STRINGID_NATUREPOWERTURNEDINTO] = COMPOUND_STRING("FORCE-NATURE se transforme\nen {B_CURRENT_MOVE}!"),
    [STRINGID_PKMNSTATUSNORMAL] = COMPOUND_STRING("Le statut du {B_ATK_NAME_WITH_PREFIX}\nrevient à la normale!"),
    [STRINGID_PKMNHASNOMOVESLEFT]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} has no moves left that it can use!\p"),
    [STRINGID_PKMNSUBJECTEDTOTORMENT] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} est victime de la\nTOURMENTE!"),
    ...
    [STRINGID_PKMNTIGHTENINGFOCUS] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} se concentre\ndavantage!"),
    [STRINGID_PKMNFELLFORTAUNT] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} répond à\nla PROVOC!"),
    [STRINGID_PKMNCANTUSEMOVETAUNT]                 = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} can't use {B_CURRENT_MOVE} after the taunt!\p"),
    [STRINGID_PKMNREADYTOHELP] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} est prêt à aider\n{B_DEF_NAME_WITH_PREFIX}!"),
    [STRINGID_PKMNSWITCHEDITEMS] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} change d'objet\navec l'autre POKéMON!"),
    [STRINGID_PKMNCOPIEDFOE] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} copie\n{B_DEF_ABILITY}\ldu {B_DEF_NAME_WITH_PREFIX}!"),
    [STRINGID_PKMNWISHCAMETRUE] = COMPOUND_STRING("Le VOEU du {B_BUFF1}\nse réalise!"),
    [STRINGID_PKMNPLANTEDROOTS] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} plante ses\nracines!"),
    [STRINGID_PKMNABSORBEDNUTRIENTS] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} absorbe des\nnutriments avec ses racines!"),
    [STRINGID_PKMNANCHOREDITSELF] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} s'accroche\navec ses racines!"),
    [STRINGID_PKMNWASMADEDROWSY] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} rend\n{B_DEF_NAME_WITH_PREFIX} somnolent!"),
    [STRINGID_PKMNKNOCKEDOFF] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} fait tomber\n{B_LAST_ITEM}\ldu {B_DEF_NAME_WITH_PREFIX}!"),
    [STRINGID_PKMNSWAPPEDABILITIES] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} et le POKéMON\néchangent leur capacité spéciale!"),
    [STRINGID_PKMNSEALEDOPPONENTMOVE] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} bloque une ou\nplusieurs capacités de l'adversaire!"),
    [STRINGID_PKMNCANTUSEMOVESEALED]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} can't use its sealed {B_CURRENT_MOVE}!\p"),
    [STRINGID_PKMNWANTSGRUDGE] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} veut que\nl'adversaire ait de la RANCUNE!"),
    [STRINGID_PKMNLOSTPPGRUDGE] = COMPOUND_STRING("{B_BUFF1} du {B_ATK_NAME_WITH_PREFIX}\nperd ses PP à cause de la RANCUNE!"),
    [STRINGID_PKMNSHROUDEDITSELF] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} s'entoure\nde {B_CURRENT_MOVE}!"),
    [STRINGID_PKMNMOVEBOUNCED] = COMPOUND_STRING("{B_CURRENT_MOVE} du {B_ATK_NAME_WITH_PREFIX}\nest renvoyé par le REFLET MAGIK!"),
    [STRINGID_PKMNWAITSFORTARGET] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} attend que son\nennemi attaque!"),
    ...
    [STRINGID_PKMNPROTECTEDBY] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} est protégé\npar {B_DEF_ABILITY}!"), //not in gen 5+, ability popup
    [STRINGID_PKMNPREVENTSUSAGE] = COMPOUND_STRING("{B_DEF_ABILITY} de\n{B_DEF_NAME_WITH_PREFIX} \pempêche {B_ATK_NAME_WITH_PREFIX}\nd'utiliser {B_CURRENT_MOVE}!"), //I don't see this in SV text
    [STRINGID_PKMNRESTOREDHPUSING] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} restaure ses PV\ngrâce à {B_DEF_ABILITY}!"), //not in gen 5+, ability popup
    [STRINGID_PKMNCHANGEDTYPEWITH] = COMPOUND_STRING("{B_DEF_ABILITY} du {B_DEF_NAME_WITH_PREFIX}\nle transforme en type {B_BUFF1}!"), //not in gen 5+, ability popup
    [STRINGID_PKMNPREVENTSROMANCEWITH] = COMPOUND_STRING("{B_DEF_ABILITY} du {B_DEF_NAME_WITH_PREFIX}\nempêche la romance!"), //not in gen 5+, ability popup
    [STRINGID_PKMNPREVENTSCONFUSIONWITH] = COMPOUND_STRING("{B_DEF_ABILITY} du {B_DEF_NAME_WITH_PREFIX}\nempêche la confusion!"), //not in gen 5+, ability popup
    [STRINGID_PKMNRAISEDFIREPOWERWITH] = COMPOUND_STRING("{B_DEF_ABILITY} du {B_DEF_NAME_WITH_PREFIX}\naugmente sa puissance de FEU!"), //not in gen 5+, ability popup
    [STRINGID_PKMNANCHORSITSELFWITH] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} s'accroche\navec {B_DEF_ABILITY}!"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNHURTSWITH] = COMPOUND_STRING("{B_DEF_ABILITY} du {B_DEF_NAME_WITH_PREFIX}\nblesse {B_ATK_NAME_WITH_PREFIX}!"),
    [STRINGID_PKMNTRACED]                           = COMPOUND_STRING("It traced {B_BUFF1}'s {B_BUFF2}!"),
    [STRINGID_STATSHARPLY]                          = gText_StatSharply,
    [STRINGID_STATHARSHLY] = COMPOUND_STRING("baisse beaucoup!"),
    [STRINGID_ATTACKERSSTATROSE] = COMPOUND_STRING("Ah, {B_BUFF1} du {B_ATK_NAME_WITH_PREFIX}\n{B_BUFF2}"),
    ...
    [STRINGID_ATTACKERSSTATFELL] = COMPOUND_STRING("{B_BUFF1} du {B_ATK_NAME_WITH_PREFIX}\n{B_BUFF2}"),
    [STRINGID_DEFENDERSSTATFELL] = COMPOUND_STRING("Ah, {B_BUFF1} du {B_DEF_NAME_WITH_PREFIX}\n{B_BUFF2}"),
    [STRINGID_CRITICALHIT] = COMPOUND_STRING("Coup critique!"),
    [STRINGID_ONEHITKO] = COMPOUND_STRING("K.O. en un coup!"),
    [STRINGID_123POOF] = COMPOUND_STRING("{PAUSE 32}1, {PAUSE 15}2, and{PAUSE 15}… {PAUSE 15}… {PAUSE 15}… {PAUSE 15}{PLAY_SE SE_BALL_BOUNCE_1}Tadaa!\p"),
    ...
    [STRINGID_DOWNPOURCONTINUES] = COMPOUND_STRING("La pluie torrentielle continue."), // unused
    [STRINGID_RAINSTOPPED] = COMPOUND_STRING("La pluie s'est arrêtée."),
    [STRINGID_SANDSTORMBREWED] = COMPOUND_STRING("Une tempête de sable\nse prépare!"),
    [STRINGID_SANDSTORMRAGES] = COMPOUND_STRING("La tempête de sable\nfait rage."),
    [STRINGID_SANDSTORMSUBSIDED] = COMPOUND_STRING("La tempête de sable\nse calme."),
    [STRINGID_SUNLIGHTGOTBRIGHT] = COMPOUND_STRING("Les rayons du soleil brillent!"),
    [STRINGID_SUNLIGHTSTRONG] = COMPOUND_STRING("Les rayons du soleil sont forts."), //not in gen 5+
    ...
    [STRINGID_HAILCONTINUES] = COMPOUND_STRING("La grêle continue."),
    [STRINGID_HAILSTOPPED] = COMPOUND_STRING("La grêle s'est arrêtée."),
    [STRINGID_STATCHANGESGONE] = COMPOUND_STRING("Les changements de stats\nont tous été annulés!"),
    [STRINGID_COINSSCATTERED] = COMPOUND_STRING("Une pluie de pièces!"),
    [STRINGID_TOOWEAKFORSUBSTITUTE] = COMPOUND_STRING("Trop faible pour créer\nun CLONE!"),
    [STRINGID_SHAREDPAIN] = COMPOUND_STRING("Les adversaires se partagent\nles dégâts!"),
    [STRINGID_BELLCHIMED] = COMPOUND_STRING("Un GRELOT sonne!"),
    [STRINGID_FAINTINTHREE] = COMPOUND_STRING("Les POKéMON au combat seront\nK.O. dans 3 tours!"),
    [STRINGID_NOPPLEFT] = COMPOUND_STRING("Il n'y a plus de PP pour\ncette capacité!\p"), //not in gen 5+
    [STRINGID_BUTNOPPLEFT] = COMPOUND_STRING("Mais il n'y a plus de PP pour\ncette capacité!"),
    [STRINGID_PLAYERUSEDITEM] = COMPOUND_STRING("{B_PLAYER_NAME} utilise\n{B_LAST_ITEM}!"),
    [STRINGID_WALLYUSEDITEM] = COMPOUND_STRING("TIMMY utilise\n{B_LAST_ITEM}!"), //no decapitalize until it is everywhere
    [STRINGID_TRAINERBLOCKEDBALL] = COMPOUND_STRING("Le DRESSEUR détourne la BALL!"),
    [STRINGID_DONTBEATHIEF] = COMPOUND_STRING("Voler, c'est mal!"),
    [STRINGID_ITDODGEDBALL] = COMPOUND_STRING("Il a évité la BALL!\nCe POKéMON ne se laisse pas faire!"),
    [STRINGID_PKMNBROKEFREE] = COMPOUND_STRING("Oh, non!\nLe POKéMON s'est libéré!"),
    [STRINGID_ITAPPEAREDCAUGHT] = COMPOUND_STRING("Raaah!\nÇa y était presque!"),
    [STRINGID_AARGHALMOSTHADIT] = COMPOUND_STRING("Aaaaaah!\nPresque!"),
    ...
    [STRINGID_GIVENICKNAMECAPTURED] = COMPOUND_STRING("Donner un surnom au\n{B_OPPONENT_MON1_NAME} capturé?"),
    [STRINGID_PKMNDATAADDEDTODEX] = COMPOUND_STRING("Les données de {B_OPPONENT_MON1_NAME} sont\najoutées au POKéDEX.\p"),
    [STRINGID_ITISRAINING] = COMPOUND_STRING("Il pleut."),
    [STRINGID_SANDSTORMISRAGING] = COMPOUND_STRING("La tempête de sable\nfait rage."),
    [STRINGID_CANTESCAPE2] = COMPOUND_STRING("Fuite impossible!\p"),
    [STRINGID_PKMNIGNORESASLEEP] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} ignore les ordres\net pionce!"),
    [STRINGID_PKMNIGNOREDORDERS] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} ignore les\nordres!"),
    ...
    [STRINGID_PKMNTURNEDAWAY] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} tourne le dos!"),
    [STRINGID_PKMNPRETENDNOTNOTICE] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} fait semblant de\nne rien remarquer!"),
    ...
    [STRINGID_CREPTCLOSER] = COMPOUND_STRING("{B_PLAYER_NAME} se rapproche de\n{B_OPPONENT_MON1_NAME}!"), //safari
    [STRINGID_CANTGETCLOSER] = COMPOUND_STRING("{B_PLAYER_NAME} ne peut pas\ns'approcher plus!"), //safari
    [STRINGID_PKMNWATCHINGCAREFULLY] = COMPOUND_STRING("{B_OPPONENT_MON1_NAME} surveille\nattentivement!"), //safari
    [STRINGID_PKMNCURIOUSABOUTX] = COMPOUND_STRING("{B_OPPONENT_MON1_NAME} est intéressé par\n{B_BUFF1}!"), //safari
    [STRINGID_PKMNENTHRALLEDBYX] = COMPOUND_STRING("{B_OPPONENT_MON1_NAME} est captivé par\n{B_BUFF1}!"), //safari
    [STRINGID_PKMNIGNOREDX] = COMPOUND_STRING("{B_OPPONENT_MON1_NAME} ignore complètement\n{B_BUFF1}!"), //safari
    [STRINGID_THREWPOKEBLOCKATPKMN] = COMPOUND_STRING("{B_PLAYER_NAME} lance un {POKEBLOCK}\nà {B_OPPONENT_MON1_NAME}!"), //safari
    [STRINGID_OUTOFSAFARIBALLS] = COMPOUND_STRING("{PLAY_SE SE_DING_DONG}ANNONCEUR: Vous n'avez plus de\nSAFARI BALLS! Perdu!\p"), //safari
    ...
    [STRINGID_ITEMALLOWSONLYYMOVE] = COMPOUND_STRING("Avec {B_LAST_ITEM}, seule la capacité\n{B_CURRENT_MOVE} peut être utilisée!\p"),
    [STRINGID_PKMNHUNGONWITHX] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} tient bon grâce\nà {B_LAST_ITEM}!"),
    [STRINGID_EMPTYSTRING3]                         = gText_EmptyString3,
    [STRINGID_PKMNSXRESTOREDHPALITTLE2] = COMPOUND_STRING("{B_ATK_ABILITY} du {B_ATK_NAME_WITH_PREFIX}\nrestaure un peu ses PV!"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNSXINFATUATEDY] = COMPOUND_STRING("{B_DEF_ABILITY} du {B_DEF_NAME_WITH_PREFIX}\nrend {B_ATK_NAME_WITH_PREFIX} amoureux!"), //not in gen 5+, ability popup
    [STRINGID_PKMNSXMADEYINEFFECTIVE] = COMPOUND_STRING("{B_DEF_ABILITY} du {B_DEF_NAME_WITH_PREFIX}\nrend {B_CURRENT_MOVE} inefficace!"), //not in gen 5+, ability popup
    ...
    [STRINGID_ITSUCKEDLIQUIDOOZE] = COMPOUND_STRING("Il aspire le\nSUINTEMENT!"),
    [STRINGID_PKMNTRANSFORMED]                      = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} transformed!"),
    [STRINGID_ELECTRICITYWEAKENED] = COMPOUND_STRING("La puissance de l'électricité\nest affaiblie!"),
    [STRINGID_FIREWEAKENED] = COMPOUND_STRING("La puissance du feu\nest affaiblie!"),
    [STRINGID_PKMNHIDUNDERWATER] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} se cache sous\nl'eau!"),
    [STRINGID_PKMNSPRANGUP] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} bondit!"),
    [STRINGID_HMMOVESCANTBEFORGOTTEN] = COMPOUND_STRING("Impossible d'oublier les\ncapacités CS maintenant.\p"),
    [STRINGID_XFOUNDONEY] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} trouve\n{B_LAST_ITEM}!"),
    [STRINGID_PLAYERDEFEATEDTRAINER1]               = sText_PlayerDefeatedLinkTrainerTrainer1,
    [STRINGID_SOOTHINGAROMA] = COMPOUND_STRING("Une odeur apaisante\nflotte dans les airs!"),
    [STRINGID_ITEMSCANTBEUSEDNOW] = COMPOUND_STRING("Objets inutilisables\nici.{PAUSE 64}"), //not in gen 5+, i think
    ...
    [STRINGID_PKMNSXMADEYUSELESS] = COMPOUND_STRING("{B_DEF_ABILITY} du {B_DEF_NAME_WITH_PREFIX}\nrend {B_CURRENT_MOVE} inutile!"), //not in gen 5+, ability popup
    [STRINGID_PKMNTRAPPEDBYSANDTOMB] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} est piégé par\nle TOURBI-SABLE!"),
    ...
    [STRINGID_YOUTHROWABALLNOWRIGHT] = COMPOUND_STRING("Il faut lancer une BALL, non?\nJe… je ferai de mon mieux!"),
    [STRINGID_PKMNSXTOOKATTACK] = COMPOUND_STRING("{B_DEF_ABILITY} du {B_DEF_NAME_WITH_PREFIX}\nreçoit l'attaque!"), //In gen 5+ but without naming the ability
    [STRINGID_PKMNCHOSEXASDESTINY] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} prépare\n{B_CURRENT_MOVE}!"),
    [STRINGID_PKMNLOSTFOCUS] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} est déconcentré\net ne peut pas attaquer!"),
    [STRINGID_USENEXTPKMN] = COMPOUND_STRING("Utiliser un autre POKéMON?"),
    [STRINGID_PKMNFLEDUSINGITS] = COMPOUND_STRING("{PLAY_SE SE_FLEE}{B_ATK_NAME_WITH_PREFIX} fuit en\nutilisant {B_LAST_ITEM}!\p"),
    [STRINGID_PKMNFLEDUSING] = COMPOUND_STRING("{PLAY_SE SE_FLEE}{B_ATK_NAME_WITH_PREFIX} fuit en\nutilisant {B_ATK_ABILITY}!\p"), //not in gen 5+
    [STRINGID_PKMNWASDRAGGEDOUT] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} est traîné de\nforce au combat!\p"),
    ...
    [STRINGID_BOXISFULL] = COMPOUND_STRING("La BOITE est pleine!\nVous ne pouvez plus rien attraper!\p"),
    [STRINGID_PKMNAVOIDEDATTACK] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} évite\nl'attaque!"),
    ...
    [STRINGID_PKMNSXPREVENTSFLINCHING] = COMPOUND_STRING("{B_EFF_ABILITY} du {B_EFF_NAME_WITH_PREFIX}\nempêche la peur!"), //not in gen 5+, ability popup
    [STRINGID_PKMNALREADYHASBURN] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} est déjà\nbrûlé."),
    [STRINGID_STATSWONTDECREASE2] = COMPOUND_STRING("Les stats du {B_DEF_NAME_WITH_PREFIX}\nn'iront pas plus bas!"),
    [STRINGID_PKMNSXBLOCKSY] = COMPOUND_STRING("{B_DEF_ABILITY} du {B_DEF_NAME_WITH_PREFIX}\nbloque {B_CURRENT_MOVE}!"), //not in gen 5+, ability popup
    [STRINGID_PKMNSXWOREOFF]                        = COMPOUND_STRING("{B_ATK_TEAM1} team's {B_BUFF1} wore off!"),
    [STRINGID_THEWALLSHATTERED] = COMPOUND_STRING("Le mur vole en éclats!"), //not in gen5+, uses "your teams light screen wore off!" etc instead
    ...
    [STRINGID_ATTACKERCANTESCAPE] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} ne peut\npas fuir!"),
    [STRINGID_PKMNOBTAINEDX] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} obtient\n{B_BUFF1}!"),
    [STRINGID_PKMNOBTAINEDX2] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} obtient\n{B_BUFF2}!"),
    [STRINGID_PKMNOBTAINEDXYOBTAINEDZ] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} obtient\n{B_BUFF1}!\p{B_DEF_NAME_WITH_PREFIX} obtient\n{B_BUFF2}!"),
    ...
    [STRINGID_PKMNINCAPABLEOFPOWER] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} est incapable\nd'utiliser sa puissance!"),
    ...
    [STRINGID_DEFEATEDOPPONENTBYREFEREE] = COMPOUND_STRING("{B_PLAYER_MON1_NAME} bat {B_OPPONENT_MON1_NAME} sur\ndécision de l'ARBITRE!"),
    [STRINGID_LOSTTOOPPONENTBYREFEREE] = COMPOUND_STRING("{B_PLAYER_MON1_NAME} perd contre {B_OPPONENT_MON1_NAME}\nsur décision de l'ARBITRE!"),
    [STRINGID_TIEDOPPONENTBYREFEREE] = COMPOUND_STRING("{B_PLAYER_MON1_NAME} est à égalité avec\n{B_OPPONENT_MON1_NAME} sur décision de l'ARBITRE!"),
    [STRINGID_QUESTIONFORFEITMATCH] = COMPOUND_STRING("Voulez-vous abandonner et\nquitter le combat?"),
    [STRINGID_FORFEITEDMATCH] = COMPOUND_STRING("{B_PLAYER_NAME} abandonne le match!"),
