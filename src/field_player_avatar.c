...
{
    [PLAYER_AVATAR_STATE_NORMAL]     = {OBJ_EVENT_GFX_RIVAL_ANTOINE_NORMAL,     OBJ_EVENT_GFX_RIVAL_ANTOINE_NORMAL},
    [PLAYER_AVATAR_STATE_MACH_BIKE]  = {OBJ_EVENT_GFX_RIVAL_ANTOINE_MACH_BIKE,  OBJ_EVENT_GFX_RIVAL_ANTOINE_MACH_BIKE},
    [PLAYER_AVATAR_STATE_ACRO_BIKE]  = {OBJ_EVENT_GFX_RIVAL_ANTOINE_ACRO_BIKE,  OBJ_EVENT_GFX_RIVAL_ANTOINE_ACRO_BIKE},
    [PLAYER_AVATAR_STATE_SURFING]    = {OBJ_EVENT_GFX_RIVAL_ANTOINE_SURFING,    OBJ_EVENT_GFX_RIVAL_ANTOINE_SURFING},
    [PLAYER_AVATAR_STATE_UNDERWATER] = {OBJ_EVENT_GFX_RIVAL_ANTOINE_UNDERWATER, OBJ_EVENT_GFX_RIVAL_ANTOINE_UNDERWATER},
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = {OBJ_EVENT_GFX_RIVAL_ANTOINE_FIELD_MOVE, OBJ_EVENT_GFX_RIVAL_ANTOINE_FIELD_MOVE},
    [PLAYER_AVATAR_STATE_FISHING]    = {OBJ_EVENT_GFX_RIVAL_ANTOINE_FISHING,    OBJ_EVENT_GFX_RIVAL_ANTOINE_FISHING},
    [PLAYER_AVATAR_STATE_WATERING]   = {OBJ_EVENT_GFX_RIVAL_ANTOINE_WATERING,   OBJ_EVENT_GFX_RIVAL_ANTOINE_WATERING},
    [PLAYER_AVATAR_STATE_VSSEEKER]   = {OBJ_EVENT_GFX_RIVAL_ANTOINE_FIELD_MOVE, OBJ_EVENT_GFX_RIVAL_ANTOINE_FIELD_MOVE},
};
